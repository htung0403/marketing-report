...
export default function BillOfLadingHistoryPage() {
    const { canView } = usePermissions();
    if (!canView('ORDERS_HISTORY')) {
        return <div className="p-8 text-center text-red-600 font-bold">Bạn không có quyền truy cập trang này (ORDERS_HISTORY).</div>;
    }
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-xl font-bold text-gray-900">Lịch sử thay đổi vận đơn</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="space-y-6">
                    {loading ? (
                        ...
                        filteredLogs.map(log => {
                            ...
                            if (changes.length === 0) return null; // Hide logs with no visible changes
                                    ...
                                    <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                                        ...
                                        <div className="text-right">
                                            <div className="text-sm font-medium text-gray-900">
                                                Mã đơn: <span className="text-purple-600">{log.order_code}</span>
                                            </div>
                                        </div>
                                    </div>
