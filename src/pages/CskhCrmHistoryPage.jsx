...
export default function CskhCrmHistoryPage() {
    ...
    const fetchLogs = async () => {
        ...
        try {
            ...
            console.error("Error fetching CSKH CRM logs:", error);
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-xl font-bold text-gray-900">Lịch sử thay đổi CSKH & CRM</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-6 flex flex-wrap gap-4 items-center">
                    ...
                    <button onClick={fetchLogs} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                        Làm mới
                    </button>
                </div>
